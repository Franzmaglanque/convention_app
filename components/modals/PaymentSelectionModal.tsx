...
export type PaymentMethod = 'CASH' | 'GCASH' | 'PWALLET' | 'CREDIT_DEBIT_CARD' | 'HOME_CREDIT' | 'SHOPEE_PAY' | 'SKYRO';
...
type TerminalType = 'GCASH' | 'TANGENT';
            ...
            <View style={{ marginBottom: 16 }}>
              ...
              <View style={styles.rowInput}>
                <TouchableOpacity 
                  ...
                  onPress={() => {
                      console.log('set terminal type to GCASH')
                      setTerminalType('GCASH');
