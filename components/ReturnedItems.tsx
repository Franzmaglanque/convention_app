import { useFetchReturnedItems } from '@/hooks/useOrder';
...
const MOCK_ORDER_ITEMS = [
  { id: 1, description: 'BUY 8 PCS OF ANY NAGARAYA PRETZEL 30G FOR ONLY P50.00', sku: 'CB-001', barcode: '8901234567890', price: 450.00, returned_quantity: 2 },
    ...
    <View style={styles.itemCard}>
        ...
        <View style={styles.quantityPriceContainer}>
            ...
            <View style={styles.quantityInfo}>
                ...
                <Text style={styles.quantityValue}>{item.returned_quantity}</Text>
            </View>
            ...
            <Text style={styles.subtotalValue}>₱{(parseFloat(item.unit_price) * item.returned_quantity).toFixed(2)}</Text>
            </View>
        </View>
        </View>
    </View>
...
const ReturnedItemsList: React.FC<ReturnedItemsListProps> = ({ returned_id,visible, onClose, }) => {
    const {
        data: order_items,
        isLoading,
        isError,
        refetch,
        isRefetching
    } = useFetchReturnedItems(returned_id);
        ...
        <View style={styles.modalOverlay}>
            ...
            <View style={styles.modalFooter}>
                ...
                <View style={styles.footerItem}>
                    ...
                    {order_items?.data.reduce((sum:number, item:OrderItem) => sum + item.returned_quantity, 0)}
                    </Text>
                </View>
                <View style={styles.footerItem}>
                    ...
                    <Text style={styles.footerValue}>
                    ₱{order_items?.data.reduce((sum:number, item:OrderItem) => sum + (parseFloat(item.unit_price) * item.returned_quantity), 0).toFixed(2)}
                    </Text>
                </View>
                </View>
            </View>
